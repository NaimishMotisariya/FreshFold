    ...
    <View style={{padding:10}}>
      ...
      {services.map((service,index)=>(
        <TouchableOpacity style={{margin:10,backgroundColor:"#f2f5f2",padding:10,borderRadius:10}} key={index}>
          <Image source={{uri:service.image}} style={{width:windowWidth-300,height:windowHeight/8,borderRadius:10}}></Image>
            <Text style={{fontSize:16,color:'#28282B',alignSelf:"center",marginTop:7,fontWeight:'800'}}>{service.name}</Text>
